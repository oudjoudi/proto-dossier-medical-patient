package fr.poc.dmp.web.services.exceptionHandler;
...
import fr.poc.dmp.common.exception.TechnicalException;
 ...
 * @author jmaupoux
 */
public class DmpRequestExceptionHandler implements RequestExceptionHandler
{
    /**
     * Logger
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(DmpRequestExceptionHandler.class);
     ...
     */
    public DmpRequestExceptionHandler(ExceptionHandlerService exceptionService, ComponentSource componentSource, ResponseRenderer renderer,
