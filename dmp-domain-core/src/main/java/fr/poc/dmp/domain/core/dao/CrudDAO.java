package fr.poc.dmp.domain.core.dao;
...
public interface CrudDAO
{
     ...
     * @return returns a list of objects
     */
    <T> List<T> executeCache(String query);
     ...
     * @return returns a list of objects
     */
    <T> List<T> execute(String query, Map<String, Object> params);
